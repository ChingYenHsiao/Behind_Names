...
from NameModules.Taiwan_name_seperate import GetFirstName
from NameModules.Taiwan_name_seperate import GetLastName
from NameModules.Taiwan_name_seperate import checkLastName
import os
...
#             return int((moe_data_dict[word]['stroke_count']))
    if word in special_word_dict:
        return int(special_word_dict[word]['stroke_count'])
